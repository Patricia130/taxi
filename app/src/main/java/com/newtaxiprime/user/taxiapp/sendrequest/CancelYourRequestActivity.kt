...
/* ************************************************************
    ...
    *************************************************************** */
class CancelYourRequestActivity : CommonActivity(), ServiceListener {
...
*/
    ...
    private fun onSuccessCancelReason(jsonResp: JsonResponse) {
        ...
        if (cancelResultModel != null) {
            ...
            spinner.getBackground().setColorFilter(getResources().getColor(R.color.newtaxi_app_black),
                ...
                if (intent.action == Config.REGISTRATION_COMPLETE) {
                    ...
                    try {
                        ...
                        if (jsonObject.getJSONObject("custom").has("begin_trip")) {
                            val intent1 = Intent(this@CancelYourRequestActivity, MainActivity::class.java)
