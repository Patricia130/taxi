...
import com.newtaxiprime.user.appcommon.helper.WaveDrawable
...
import com.newtaxiprime.user.taxiapp.sendrequest.CancelYourRequestActivity
...
import com.newtaxiprime.user.taxiapp.database.IFirebaseReqListener
   ...
   fun cancel() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!overviewPolylines.isNullOrEmpty()) {
            ...
            polylineOptions.color(ContextCompat.getColor(this, R.color.newtaxi_app_yellow))
