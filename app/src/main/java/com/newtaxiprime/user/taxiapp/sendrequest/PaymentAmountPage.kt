...
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_AFTER_PAY
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_CURRENCY_CONVERT
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_GET_INVOICE
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_PAYPAL_CURRENCY
...
import com.newtaxiprime.user.taxiapp.datamodels.trip.InvoiceModel
import com.newtaxiprime.user.taxiapp.datamodels.trip.TripInvoiceModel
    ...
    override fun onSuccess(jsonResp: JsonResponse, data: String) {
        ...
        when (jsonResp.requestCode) {
            ...
            REQ_CURRENCY_CONVERT -> if (jsonResp.isSuccess) {
                ...
                }else if (sessionManager.paymentMethodkey.equals(CommonKeys.PAYMENT_MPESA)) {
                    val webview = Intent(this, MpesaPaymentWebViewActivity::class.java)
                    webview.putExtra("payableWalletAmount", payable_amt.toString())
                    webview.putExtra(Constants.INTENT_PAY_FOR, CommonKeys.PAY_FOR_TRIP)
                    webview.putExtra(Constants.PAY_FOR_TYPE, CommonKeys.AFTER_PAYMENT)
                    startActivityForResult(webview, Payment)
                }else if (sessionManager.paymentMethodkey.equals(CommonKeys.PAYMENT_PAYTM)) {
                    val webview = Intent(this, PaytmPaymentWebViewActivity::class.java)
                    webview.putExtra("payableWalletAmount", payable_amt.toString())
                    webview.putExtra(Constants.INTENT_PAY_FOR, CommonKeys.PAY_FOR_TRIP)
                    webview.putExtra(Constants.PAY_FOR_TYPE, CommonKeys.AFTER_PAYMENT)
                    startActivityForResult(webview, Payment)
                }else if (sessionManager.paymentMethodkey.equals(CommonKeys.PAYMENT_FLUTTERWAVE)) {
                    val webview = Intent(this, FlutterwaveWebViewActivity::class.java)
                    webview.putExtra("payableWalletAmount", payable_amt.toString())
                    webview.putExtra(Constants.INTENT_PAY_FOR, CommonKeys.PAY_FOR_TRIP)
                    webview.putExtra(Constants.PAY_FOR_TYPE, CommonKeys.AFTER_PAYMENT)
                    startActivityForResult(webview, Payment)
                }else if (sessionManager.paymentMethodkey.equals(CommonKeys.PAYMENT_PAYSTACK)) {
                    val webview = Intent(this, PaystackWebViewActivity::class.java)
                    webview.putExtra("payableWalletAmount", payable_amt.toString())
                    webview.putExtra(Constants.INTENT_PAY_FOR, CommonKeys.PAY_FOR_TRIP)
                    webview.putExtra(Constants.PAY_FOR_TYPE, CommonKeys.AFTER_PAYMENT)
                    startActivityForResult(webview, Payment)
                }else if (sessionManager.paymentMethodkey.equals(CommonKeys.PAYMENT_MOLLIE)) {
                    val webview = Intent(this, MollieWebViewActivity::class.java)
                    webview.putExtra("payableWalletAmount", payable_amt.toString())
                    webview.putExtra(Constants.INTENT_PAY_FOR, CommonKeys.PAY_FOR_TRIP)
                    webview.putExtra(Constants.PAY_FOR_TYPE, CommonKeys.AFTER_PAYMENT)
                    startActivityForResult(webview, Payment)
                }else if (sessionManager.paymentMethodkey.equals(CommonKeys.PAYMENT_RAZORPAY)) {
