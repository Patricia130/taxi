...
import com.newtaxiprime.user.appcommon.custompalette.CustomTypefaceSpan
import com.newtaxiprime.user.appcommon.database.SqLiteDb
import com.newtaxiprime.user.appcommon.datamodels.JsonResponse
import com.newtaxiprime.user.appcommon.drawpolyline.DirectionsJSONParser
import com.newtaxiprime.user.appcommon.helper.Constants
import com.newtaxiprime.user.appcommon.helper.Constants.Req_TYPE_NORMAL
import com.newtaxiprime.user.appcommon.helper.Constants.Req_TYPE_POOL
import com.newtaxiprime.user.appcommon.helper.Constants.scheduledDuration
import com.newtaxiprime.user.appcommon.helper.LatLngInterpolator
import com.newtaxiprime.user.appcommon.helper.Permission
...
import com.newtaxiprime.user.appcommon.map.AppUtils
import com.newtaxiprime.user.appcommon.network.AppController
import com.newtaxiprime.user.appcommon.network.PermissionCamer
import com.newtaxiprime.user.appcommon.placesearch.InfoWindowData
...
import com.newtaxiprime.user.appcommon.utils.CommonMethods.Companion.startChatActivityFrom
import com.newtaxiprime.user.appcommon.utils.CommonMethods.Companion.startSinchService
import com.newtaxiprime.user.appcommon.utils.Enums.REG_GET_PAYMENTMETHOD
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_COMMON_DATA
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_GET_DRIVER
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_GET_RIDER_PROFILE
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_NEAREST_CARS
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_SEARCH_CARS
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_SEND_REQUEST
...
import com.newtaxiprime.user.taxiapp.adapters.SeatsListAdapter
import com.newtaxiprime.user.taxiapp.database.AddFirebaseDatabase
import com.newtaxiprime.user.taxiapp.datamodels.DriverLocation
...
import com.newtaxiprime.user.taxiapp.datamodels.main.NearByCarsModel
...
import com.newtaxiprime.user.taxiapp.firebase_keys.FirebaseDbKeys
import com.newtaxiprime.user.taxiapp.firebase_keys.FirebaseDbKeys.LIVE_TRACKING_NODE
import com.newtaxiprime.user.taxiapp.firebase_keys.FirebaseDbKeys.TRIP_PAYMENT_NODE
...
import com.newtaxiprime.user.taxiapp.views.main.filter.FeatureSelectListener
...
/* ************************************************************
  This is the main page for rider shown after login
   *********************************************************** */

class MainActivity : CommonActivity(), SeatsListAdapter.OnClickListener,OnMapReadyCallback,
    ...
    fun schedulerideSearchCar() {
        ...
        if (!isInternetAvailable) {
            ...
            locationHashMap["car_type"] = sessionManager.carType.toString()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
       ...
       // Disable opening the drawer
        drawerLayout.setDrawerLockMode(DrawerLayout.LOCK_MODE_LOCKED_CLOSED)

      // Disable user interactions with the drawer view
    ...
    fun loadbanners(){
        ...
        val hashMap = HashMap<String, String>() // Create a HashMap for query parameters if needed

        val call = apiService.getBanners(hashMap) // Make the API call
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                if (response.isSuccessful) {
                    ...
                    for (i in 0 until bannersArray.length()) {
                        val bannerObject = bannersArray.getJSONObject(i)
                        val imageUrl = bannerObject.getString("imageurl")

                        // Create a SlideModel instance with the retrieved image URL
                        slideModels.add(SlideModel(imageUrl, ScaleTypes.FIT))
                    }

                    // Update the imageSlider with the new slideModels
    ...
    private fun bottomnav(){
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener { menuItem ->
            when (menuItem.itemId) {
                R.id.wallet -> {
                    val walletIntent = Intent(this, AddWalletActivity::class.java)
                ...
                R.id.myride -> {
                    val myride = Intent(this, YourTrips::class.java)
                    myride.putExtra("upcome", "")
                    startActivity(myride)
                    overridePendingTransition(R.anim.ub__slide_in_right, R.anim.ub__slide_out_left)
                    true
                }
                R.id.acccount -> {
                ...
                R.id.settings -> {
                    val settingsIntent = Intent(this, Setting::class.java)
...
// carmarker.setIcon(BitmapDescriptorFactory.fromResource(R.drawable.ic_booking_prime_map_topview));
    ...
    private fun buildAlertMessageNoGps() {
        ...
        builder.setMessage("Your GPS device seems to be disabled, do you want to enable it?")
                .setCancelable(false)
...
/* fun getLocation(){
        ...
        if (enable) {
            ...
            if (!mToolBarNavigationListenerIsRegistered) {
                toggle.toolbarNavigationClickListener = View.OnClickListener {
                    ...
                    card_map.visibility = View.GONE

                    horiviewsslides.visibility = View.VISIBLE
                    imageslide.visibility = View.VISIBLE
                    card_map_view.visibility = View.VISIBLE
    ...
    private fun searchViewset(pickup: LatLng?, drop: LatLng?) {
        ...
        card_map.visibility = View.VISIBLE
        horiviewsslides.visibility = View.GONE
        imageslide.visibility = View.GONE
        card_map_view.visibility = View.GONE
...
*/
    ...
    private fun onSuccessProfile(jsonResp: String) {
        ...
        sessionManager.walletAccount =riderProfile.walletAccount
        ...
        withContext(Dispatchers.IO) {
            ...
            if (routes != null) {
                for (i in routes.indices) {
                    ...
                    lineOptions.color(ContextCompat.getColor(this@MainActivity, R.color.newtaxi_app_yellow))
    ...
    private fun Updatepolyline(driverlatlng: LatLng) {
        ...
        if (!isonPath) {
            ...
            if (newPoints.size > 0) {
                ...
                lineOptions.width(8f)
                lineOptions.color(ContextCompat.getColor(this, R.color.newtaxi_app_yellow))
                lineOptions.geodesic(true)
                polyline?.remove()
