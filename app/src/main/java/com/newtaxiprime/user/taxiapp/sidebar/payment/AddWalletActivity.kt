...
import com.newtaxiprime.user.appcommon.helper.Constants.INTENT_PAY_FOR
import com.newtaxiprime.user.appcommon.helper.Constants.Payment
...
import com.newtaxiprime.user.appcommon.utils.CommonKeys.PAY_FOR_WALLET
...
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_ADD_WALLET
import com.newtaxiprime.user.appcommon.utils.Enums.REQ_CURRENCY_CONVERT
...
class AddWalletActivity : CommonActivity(), ServiceListener, PaymentMethodNonceCreatedListener {
    ...
    lateinit var wallet_acc: TextView
    ...
    @OnClick(R.id.transfermoney)
    fun tranfer(){
        val profileIntent = Intent(this, TransferMoney::class.java)
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        wallet_acc.text = sessionManager.walletAccount
            ...
            if (walletamt.text.trim().length > 1 && walletamt.text.trim().substring(2).toFloat() > 0) {
                ...
                if (sessionManager.payementModeWebView!!) {
                    ...
                    if (sessionManager.walletPaymentMethodkey!!.isNotEmpty() && !sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_CASH)) {
                        ...
                        if (sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_PAYTM)) {
                            val webview = Intent(this, PaytmPaymentWebViewActivity::class.java)
                            webview.putExtra("payableWalletAmount", payableWalletAmount)
                            webview.putExtra(INTENT_PAY_FOR, PAY_FOR_WALLET)
                            startActivityForResult(webview, Payment)
                        } else {
                        ...
                        if (sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_MPESA)) {
                            val webview = Intent(this, MpesaPaymentWebViewActivity::class.java)
                            webview.putExtra("payableWalletAmount", payableWalletAmount)
                            webview.putExtra(INTENT_PAY_FOR, PAY_FOR_WALLET)
                            startActivityForResult(webview, Payment)
                        } else {
                        ...
                        if (sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_FLUTTERWAVE)) {
                            val webview = Intent(this, FlutterwaveWebViewActivity::class.java)
                            webview.putExtra("payableWalletAmount", payableWalletAmount)
                            webview.putExtra(INTENT_PAY_FOR, PAY_FOR_WALLET)
                            startActivityForResult(webview, Payment)
                        } else {
                        ...
                        if (sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_PAYSTACK)) {
                            val webview = Intent(this, PaystackWebViewActivity::class.java)
                            webview.putExtra("payableWalletAmount", payableWalletAmount)
                            webview.putExtra(INTENT_PAY_FOR, PAY_FOR_WALLET)
                            startActivityForResult(webview, Payment)
                        } else {
                        ...
                        if (sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_MOLLIE)) {
                            val webview = Intent(this, MollieWebViewActivity::class.java)
                            webview.putExtra("payableWalletAmount", payableWalletAmount)
                            webview.putExtra(INTENT_PAY_FOR, PAY_FOR_WALLET)
                            startActivityForResult(webview, Payment)
                        } else {
                        ...
                        if (sessionManager.walletPaymentMethodkey.equals(CommonKeys.PAYMENT_RAZORPAY)) {
                            val webview = Intent(this, RazorpayWebViewActivity::class.java)
                            webview.putExtra("payableWalletAmount", payableWalletAmount)
                            webview.putExtra(INTENT_PAY_FOR, PAY_FOR_WALLET)
                            startActivityForResult(webview, Payment)
                        } else {
