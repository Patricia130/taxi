...
class PaytmPaymentWebViewActivity : CommonActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.paytm), common_header)
        ...
        payment_wv.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                commonMethods.showProgressDialog(this@PaytmPaymentWebViewActivity)
            }
        ...
        val url = resources.getString(R.string.base_url) + CommonKeys.PAYMENT_PAYTM_WEBVIEW_KEY
