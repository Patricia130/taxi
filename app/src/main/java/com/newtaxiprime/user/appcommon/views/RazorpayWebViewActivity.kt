...
class RazorpayWebViewActivity : CommonActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.razorpay), common_header)
        ...
        payment_wv.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                commonMethods.showProgressDialog(this@RazorpayWebViewActivity)
            }
        ...
        //payment_wv.settings.setSupportMultipleWindows(true);
        payment_wv.settings.javaScriptCanOpenWindowsAutomatically = true;
        payment_wv.addJavascriptInterface(MyJavaScriptInterface(this), "android")

        val url = resources.getString(R.string.base_url) + CommonKeys.PAYMENT_RAZORPAY_WEBVIEW_KEY
