...
class MpesaPaymentWebViewActivity : CommonActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.mpesa), common_header)
        ...
        payment_wv.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                commonMethods.showProgressDialog(this@MpesaPaymentWebViewActivity)
            }
        ...
        val url = resources.getString(R.string.base_url) + CommonKeys.PAYMENT_MPESA_WEBVIEW_KEY
