...
class MollieWebViewActivity : CommonActivity() {
    @Inject
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        commonMethods.setheaderText(resources.getString(R.string.mollie), common_header)
        ...
        payment_wv.webViewClient = object : WebViewClient() {
            override fun onPageStarted(view: WebView, url: String, favicon: Bitmap?) {
                ...
                commonMethods.showProgressDialog(this@MollieWebViewActivity)
            }
        ...
        val url = resources.getString(R.string.base_url) + CommonKeys.PAYMENT_MOLLIE_WEBVIEW_KEY
